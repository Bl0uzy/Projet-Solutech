...
f=e.bPaginate;return e.bServerSide?!1===f||-1===a?b+d:Math.min(b+a,this._iRecordsDisplay):!f||c>d||-1===a?d:c},oInstance:null,sInstance:null,iTabIndex:0,nScrollHead:null,nScrollFoot:null,aLastSort:[],oPlugins:{},rowIdFn:null,rowId:null};u.ext=L={buttons:{},classes:{},build:"zf-6.4.3/dt-1.10.23/b-1.6.5/b-colvis-1.6.5/fc-3.3.2/fh-3.1.7/kt-2.5.3/r-2.2.7/sc-2.0.3/sb-1.0.1/sp-1.2.2",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:u.fnVersionCheck,
...
e||b("div.DTE_Field_InputControl input, div.DTE_Field_InputControl editTicket").select();h.keys.enable(e?"tab-only":"navigation-only");h.on("key-blur.editor",function(r,v,x){p.displayed()&&x.node()===l.node()&&p.submit()});e&&b(h.table().container()).addClass("dtk-focus-alt");p.on("preSubmitCancelled"+f,function(){setTimeout(function(){d._focus(l,null,!1)},50)});p.on("submitUnsuccessful"+f,function(){d._focus(l,null,!1)});p.one("close"+f,function(){h.keys.enable(!0);h.off("key-blur.editor");p.off(f);
